#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Módulo para proveer la clase `ArbolPihi`.
...
class ArbolPihi(Arbol):
    """Clase para representar objetos de tipo `ArbolPihi`.
    Una subclase que hereda de 'Arbol' y provee un tipo para representar
    árboles individuales de *Pinus elliottii* var. *ellliottii* × *P. 
    caribaea* var. *hondurensis* F2 (pino híbrido F2). A los atributos de 
    la superclase se agrega uno nuevo para describir la especie y también 
    es tratado como una propiedad. El resto de los atributos o métodos 
    ...
    _SP = 'Pinus elliottii var. ellliottii × P. caribaea var. hondurensis F2'
    #_GAMMA : float
    #    Constante necesaria para varias funciones de la clase.
    _GAMMA = 2.0925
    
    def __init__(self, i, d, h):
        r"""Crea una instancia de `ArbolPihi`.
