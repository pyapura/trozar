#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Módulo para proveer la clase `ArbolPita`.
Última modificación: 12/02/2026 - 16.08.20
@author: ypf
"""
import math
#import numpy as np
...
class ArbolPita(Arbol):
    """Clase para representar objetos de tipo `ArbolPita`.
    Una subclase que hereda de 'Arbol' y provee un tipo para representar
    árboles individuales de *Pinus taeda*. A los atributos de la superclase
    se agrega uno nuevo para describir la especie y también es tratado como
    una propiedad. El resto de los atributos o métodos codifican la
    implementación concreta de los marcados como abstractos en la
    superclase.
    ...
    def __init__(self, i, d, h):
        r"""Crea una instancia de `ArbolPita`.
    ...
    def v(self):
        ...
        References
        ----------
        .. [1] Sañudo, G.; Yapura, P.; Caraballo, H.; Fassola, H.; Keller,
        A. & Crechi, E. (2022). Funciones de forma del fuste y modelos de
        volumen compatibles para *Pinus taeda* en Misiones y Corrientes.
        Inédito. 19 pp.
        """
        gamma = self._GAMMA
