#
# trozar documentation build configuration file
#
import os
import sys
...
project = "trozar"
copyright = "Copyright © 2026 Pablo Yapura"
...
# built documents.
try:
    version = importlib.metadata.version("trozar")
